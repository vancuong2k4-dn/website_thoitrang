...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class ExtendedStoredProcedure  : IObjectPermission
	{
		public ExtendedStoredProcedure() : base(){ }
		public ExtendedStoredProcedure(Database database, string name) : base()
		{
			ValidateName(name);
			this.key = new SchemaObjectKey(name, null);
			this.Parent = database;
		}
		public ExtendedStoredProcedure(Database database, string name, string schema) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			public override int PropertyNameToIDLookup(string propertyName)
			{
				if(this.DatabaseEngineType == DatabaseEngineType.SqlAzureDatabase)
				{
					...
					else
					{
						switch(propertyName)
						{
							...
							case "ID": return 2;
							case "IsSchemaOwned": return 3;
							case "IsSystemObject": return 4;
							case "Owner": return 5;
							case "DllLocation": return 6;
						}
						return -1;
					}
				}
				else
				{
					...
					{
						case "CreateDate": return 0;
						case "DllLocation": return 1;
						case "ID": return 2;
						case "IsSystemObject": return 3;
						case "Owner": return 4;
						case "DateLastModified": return 5;
						case "IsSchemaOwned": return 6;
						case "PolicyHealthState": return 7;
					}
					return -1;
				}
			}
			static int [] versionCount = new int [] { 5, 5, 7, 8, 8, 8, 8, 8, 8, 8, 8, 8 };
			static int [] cloudVersionCount = new int [] { 6, 6, 7 };
			...
			internal static StaticMetadata [] cloudStaticMetadata = 
			{
				...
				new StaticMetadata("DllLocation", false, false, typeof(System.String)),
			};
		...
		public System.String DllLocation
		{
			get
			{
				return (System.String)this.Properties.GetValueWithNullReplacement("DllLocation");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("DllLocation", value);
			}
		}
		[SfcProperty(SfcPropertyFlags.SqlAzureDatabase |SfcPropertyFlags.Standalone)]
