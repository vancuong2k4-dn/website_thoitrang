...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class PartitionScheme  : ISfcSupportsDesignMode
	{
		public PartitionScheme() : base(){ }
		public PartitionScheme(Database database, string name) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			public override int PropertyNameToIDLookup(string propertyName)
			{
				if(this.DatabaseEngineType == DatabaseEngineType.SqlAzureDatabase)
				{
					if(this.DatabaseEngineEdition == DatabaseEngineEdition.SqlDataWarehouse)
					{
						...
						{
							case "ID": return 0;
							case "PartitionFunction": return 1;
						}
						return -1;
					}
					else
					{
						...
						{
							case "ID": return 0;
							case "NextUsedFileGroup": return 1;
							case "PartitionFunction": return 2;
						}
						return -1;
					}
				}
			...
			static int sqlDwPropertyCount = 2;
			...
			internal static StaticMetadata [] sqlDwStaticMetadata = 
			{
				...
				new StaticMetadata("PartitionFunction", false, false, typeof(System.String)),
			};
			internal static StaticMetadata [] cloudStaticMetadata = 
			{
				new StaticMetadata("ID", false, true, typeof(System.Int32)),
				new StaticMetadata("NextUsedFileGroup", false, false, typeof(System.String)),
				new StaticMetadata("PartitionFunction", false, false, typeof(System.String)),
			};
		...
		[SfcProperty(SfcPropertyFlags.SqlAzureDatabase |SfcPropertyFlags.Standalone)]
		public System.String NextUsedFileGroup
		{
			get
			{
				return (System.String)this.Properties.GetValueWithNullReplacement("NextUsedFileGroup");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("NextUsedFileGroup", value);
			}
		}
		[SfcProperty(SfcPropertyFlags.ReadOnlyAfterCreation |SfcPropertyFlags.SqlAzureDatabase |SfcPropertyFlags.Standalone)]
		[SfcReference(typeof(PartitionFunction),"Server[@Name = '{0}']/Database[@Name = '{1}']/PartitionFunction[@Name = '{2}']","Parent.Parent.ConnectionContext.TrueName","Parent.Name","PartitionFunction")]
		[CLSCompliant(false)]
		public System.String PartitionFunction
		{
			get
			{
				return (System.String)this.Properties.GetValueWithNullReplacement("PartitionFunction");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("PartitionFunction", value);
			}
		}
		internal override string[] GetNonAlterableProperties()
		{
			return new string[] { "PartitionFunction" };
		}
      ...
      public PartitionSchemeEvents Events
      {
          ...
          get
          {
              ...
              if (null == this.events)
              {
                  this.events = new PartitionSchemeEvents(this);
              }
              return this.events;
          }
      }
