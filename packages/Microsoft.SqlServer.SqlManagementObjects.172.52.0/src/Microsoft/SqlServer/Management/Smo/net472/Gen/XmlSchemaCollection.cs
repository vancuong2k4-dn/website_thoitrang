...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class XmlSchemaCollection  : ISfcSupportsDesignMode, IObjectPermission
	{
		public XmlSchemaCollection() : base(){ }
		public XmlSchemaCollection(Database database, string name) : base()
		{
			ValidateName(name);
			this.key = new SchemaObjectKey(name, null);
			this.Parent = database;
		}
		public XmlSchemaCollection(Database database, string name, string schema) : base()
		{
			ValidateName(name);
