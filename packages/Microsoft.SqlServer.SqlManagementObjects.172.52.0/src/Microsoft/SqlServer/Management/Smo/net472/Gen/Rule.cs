...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class Rule  : ISfcSupportsDesignMode
	{
		public Rule() : base(){ }
		public Rule(Database database, string name) : base()
		{
			ValidateName(name);
			this.key = new SchemaObjectKey(name, null);
			this.Parent = database;
		}
		public Rule(Database database, string name, string schema) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			static int [] versionCount = new int [] { 4, 4, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6 };
