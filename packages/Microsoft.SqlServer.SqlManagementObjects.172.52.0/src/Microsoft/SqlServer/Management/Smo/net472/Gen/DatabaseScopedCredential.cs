...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class DatabaseScopedCredential  : IObjectPermission
	{
		public DatabaseScopedCredential() : base(){ }
		public DatabaseScopedCredential(Database database, string name) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			static int [] versionCount = new int [] { 0, 0, 0, 0, 0, 0, 0, 4, 4, 4, 4, 4 };
