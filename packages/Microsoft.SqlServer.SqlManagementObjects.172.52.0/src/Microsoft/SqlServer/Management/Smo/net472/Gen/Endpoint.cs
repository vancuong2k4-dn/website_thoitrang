...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class Endpoint  : IObjectPermission
	{
		public Endpoint() : base(){ }
		public Endpoint(Server server, string name) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			public override int PropertyNameToIDLookup(string propertyName)
			{
				...
				else
				{
					switch(propertyName)
					{
						case "EndpointState": return 0;
						case "EndpointType": return 1;
						case "ID": return 2;
						case "IsAdminEndpoint": return 3;
						case "IsSystemObject": return 4;
						case "Owner": return 5;
						case "ProtocolType": return 6;
			...
			{
				new StaticMetadata("EndpointState", false, true, typeof(Microsoft.SqlServer.Management.Smo.EndpointState)),
				new StaticMetadata("EndpointType", false, false, typeof(Microsoft.SqlServer.Management.Smo.EndpointType)),
				new StaticMetadata("ID", false, true, typeof(System.Int32)),
				new StaticMetadata("IsAdminEndpoint", false, true, typeof(System.Boolean)),
				...
				new StaticMetadata("ProtocolType", false, false, typeof(Microsoft.SqlServer.Management.Smo.ProtocolType)),
				new StaticMetadata("PolicyHealthState", true, false, typeof(Microsoft.SqlServer.Management.Dmf.PolicyHealthState)),
			};
		}
		[SfcProperty(SfcPropertyFlags.Standalone)]
		public Microsoft.SqlServer.Management.Smo.EndpointState EndpointState
		{
			get
			{
				return (Microsoft.SqlServer.Management.Smo.EndpointState)this.Properties.GetValueWithNullReplacement("EndpointState");
			}
		}
		[SfcProperty(SfcPropertyFlags.Standalone)]
		public Microsoft.SqlServer.Management.Smo.EndpointType EndpointType
		{
			get
			{
				return (Microsoft.SqlServer.Management.Smo.EndpointType)this.Properties.GetValueWithNullReplacement("EndpointType");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("EndpointType", value);
			}
		}
		[SfcProperty(SfcPropertyFlags.Standalone)]
		...
		[SfcProperty(SfcPropertyFlags.Standalone)]
		public System.Boolean IsAdminEndpoint
		{
			get
			{
				return (System.Boolean)this.Properties.GetValueWithNullReplacement("IsAdminEndpoint");
			}
		}
		[SfcProperty(SfcPropertyFlags.Standalone)]
		...
		[SfcProperty(SfcPropertyFlags.Standalone)]
		public Microsoft.SqlServer.Management.Smo.ProtocolType ProtocolType
		{
			get
			{
				return (Microsoft.SqlServer.Management.Smo.ProtocolType)this.Properties.GetValueWithNullReplacement("ProtocolType");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("ProtocolType", value);
			}
		}
