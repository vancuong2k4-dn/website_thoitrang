...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class SecurityPolicy  : IObjectPermission
	{
		public SecurityPolicy() : base(){ }
		public SecurityPolicy(Database database, string name) : base()
		{
			ValidateName(name);
			this.key = new SchemaObjectKey(name, null);
			this.Parent = database;
		}
		public SecurityPolicy(Database database, string name, string schema) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			static int [] versionCount = new int [] { 0, 0, 0, 0, 0, 0, 0, 8, 8, 8, 8, 8 };
		...
		{
			return new string[] { "IsSchemaBound" };
		}
