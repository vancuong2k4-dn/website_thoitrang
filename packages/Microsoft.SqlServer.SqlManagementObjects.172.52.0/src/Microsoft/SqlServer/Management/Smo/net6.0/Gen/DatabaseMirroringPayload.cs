...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class DatabaseMirroringPayload 
	{
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			public override int PropertyNameToIDLookup(string propertyName)
			{
				...
				else
				{
					switch(propertyName)
					{
						...
						case "ServerMirroringRole": return 5;
					}
					return -1;
				}
			}
			...
			internal static StaticMetadata [] staticMetadata = 
			{
				...
				new StaticMetadata("ServerMirroringRole", false, false, typeof(Microsoft.SqlServer.Management.Smo.ServerMirroringRole)),
			};
		}
		...
		[SfcProperty(SfcPropertyFlags.Standalone)]
		public Microsoft.SqlServer.Management.Smo.ServerMirroringRole ServerMirroringRole
		{
			get
			{
				return (Microsoft.SqlServer.Management.Smo.ServerMirroringRole)this.Properties.GetValueWithNullReplacement("ServerMirroringRole");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("ServerMirroringRole", value);
			}
		}
	}
}
