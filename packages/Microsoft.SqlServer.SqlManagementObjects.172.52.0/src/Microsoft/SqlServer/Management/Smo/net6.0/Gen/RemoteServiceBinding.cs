...
namespace Microsoft.SqlServer.Management.Smo.Broker
{
	...
	/// </summary>
	/// <inheritdoc/>
	public sealed partial class RemoteServiceBinding  : IObjectPermission
	{
		public RemoteServiceBinding() : base(){ }
		public RemoteServiceBinding(ServiceBroker serviceBroker, string name) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			public override int PropertyNameToIDLookup(string propertyName)
			{
				...
				else
				{
					switch(propertyName)
					{
						case "CertificateUser": return 0;
						case "ID": return 1;
						case "IsAnonymous": return 2;
						case "Owner": return 3;
						case "RemoteService": return 4;
						case "PolicyHealthState": return 5;
					}
					return -1;
				}
			}
			static int [] versionCount = new int [] { 0, 0, 5, 6, 6, 6, 6, 6, 6, 6, 6, 6 };
			...
			{
				new StaticMetadata("CertificateUser", false, false, typeof(System.String)),
				new StaticMetadata("ID", false, true, typeof(System.Int32)),
				new StaticMetadata("IsAnonymous", false, false, typeof(System.Boolean)),
		...
		[SfcReference(typeof(User),"Server[@Name = '{0}']/Database[@Name = '{1}']/User[@Name = '{2}']","Parent.Parent.Parent.ConnectionContext.TrueName","Parent.Parent.Name","CertificateUser")]
		[CLSCompliant(false)]
		public System.String CertificateUser
		{
			get
			{
				return (System.String)this.Properties.GetValueWithNullReplacement("CertificateUser");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("CertificateUser", value);
			}
		}
		[SfcProperty(SfcPropertyFlags.Standalone)]
		...
		public System.Boolean IsAnonymous
		{
			get
			{
				return (System.Boolean)this.Properties.GetValueWithNullReplacement("IsAnonymous");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("IsAnonymous", value);
			}
		}
      ...
      public RemoteServiceBindingEvents Events
      {
          ...
          get
          {
              ...
              if (null == this.events)
              {
                  this.events = new RemoteServiceBindingEvents(this);
              }
              return this.events;
          }
      }
