...
namespace Microsoft.SqlServer.Management.Smo.Broker
{
	...
	/// </summary>
	/// <inheritdoc/>
	public sealed partial class ServiceContractMapping  : ISfcSupportsDesignMode
	{
		public ServiceContractMapping() : base(){ }
		public ServiceContractMapping(BrokerService brokerService, string name) : base()
		{
			ValidateName(name);
			this.key = new SimpleObjectKey(name);
			this.Parent = brokerService;
		}
