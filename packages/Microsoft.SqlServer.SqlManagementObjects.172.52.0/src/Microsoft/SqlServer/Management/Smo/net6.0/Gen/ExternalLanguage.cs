...
{
	/// <summary>
	/// Instance class encapsulating : Server[@Name='']/Database/ExternalLanguage
	/// </summary>
	/// <inheritdoc/>
	[SfcElement( SfcElementFlags.Standalone )]
	public sealed partial class ExternalLanguage  : ISfcSupportsDesignMode, IObjectPermission
	{
		public ExternalLanguage() : base(){ }
		public ExternalLanguage(Database database, string name) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			static int [] versionCount = new int [] { 0, 0, 0, 0, 0, 0, 0, 0, 0, 3, 3, 3 };
