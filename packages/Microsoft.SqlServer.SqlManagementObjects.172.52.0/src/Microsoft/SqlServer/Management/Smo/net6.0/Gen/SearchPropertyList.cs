...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class SearchPropertyList  : IObjectPermission
	{
		public SearchPropertyList() : base(){ }
		public SearchPropertyList(Database database, string name) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			static int [] versionCount = new int [] { 0, 0, 0, 0, 0, 5, 5, 5, 5, 5, 5, 5 };
