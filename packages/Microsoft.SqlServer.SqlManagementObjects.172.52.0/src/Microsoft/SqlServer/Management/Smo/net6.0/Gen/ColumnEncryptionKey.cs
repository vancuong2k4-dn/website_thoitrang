...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class ColumnEncryptionKey 
	{
		public ColumnEncryptionKey() : base(){ }
		public ColumnEncryptionKey(Database database, string name) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			static int [] versionCount = new int [] { 0, 0, 0, 0, 0, 0, 0, 3, 3, 3, 3, 3 };
		...
		{
			return new string[] { "CreateDate", "DateLastModified", "ID" };
		}
	}
}
