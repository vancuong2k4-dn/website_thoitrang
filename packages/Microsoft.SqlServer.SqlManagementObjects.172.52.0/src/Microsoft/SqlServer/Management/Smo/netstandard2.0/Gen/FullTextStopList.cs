...
namespace Microsoft.SqlServer.Management.Smo
{
	...
	public sealed partial class FullTextStopList  : ISfcSupportsDesignMode, IObjectPermission
	{
		public FullTextStopList() : base(){ }
		public FullTextStopList(Database database, string name) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			static int [] versionCount = new int [] { 0, 0, 0, 3, 3, 3, 3, 3, 3, 3, 3, 3 };
