...
namespace Microsoft.SqlServer.Management.Smo.Broker
{
	...
	/// </summary>
	/// <inheritdoc/>
	public sealed partial class MessageType  : IObjectPermission
	{
		public MessageType() : base(){ }
		public MessageType(ServiceBroker serviceBroker, string name) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			public override int PropertyNameToIDLookup(string propertyName)
			{
				...
				else
				{
					switch(propertyName)
					{
						...
						case "MessageTypeValidation": return 2;
						case "Owner": return 3;
						case "ValidationXmlSchemaCollection": return 4;
						case "ValidationXmlSchemaCollectionSchema": return 5;
						case "PolicyHealthState": return 6;
					}
					return -1;
				}
			}
			static int [] versionCount = new int [] { 0, 0, 6, 7, 7, 7, 7, 7, 7, 7, 7, 7 };
			...
			internal static StaticMetadata [] staticMetadata = 
			{
				...
				new StaticMetadata("MessageTypeValidation", false, false, typeof(Microsoft.SqlServer.Management.Smo.Broker.MessageTypeValidation)),
				new StaticMetadata("Owner", false, false, typeof(System.String)),
				new StaticMetadata("ValidationXmlSchemaCollection", false, false, typeof(System.String)),
				new StaticMetadata("ValidationXmlSchemaCollectionSchema", false, false, typeof(System.String)),
		...
		[SfcProperty(SfcPropertyFlags.Standalone)]
		public Microsoft.SqlServer.Management.Smo.Broker.MessageTypeValidation MessageTypeValidation
		{
			get
			{
				return (Microsoft.SqlServer.Management.Smo.Broker.MessageTypeValidation)this.Properties.GetValueWithNullReplacement("MessageTypeValidation");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("MessageTypeValidation", value);
			}
		}
		[SfcProperty(SfcPropertyFlags.Standalone)]
		...
		[SfcProperty(SfcPropertyFlags.Standalone)]
		[SfcReference(typeof(XmlSchemaCollection),"Server[@Name = '{0}']/Database[@Name = '{1}']/XmlSchemaCollection[@Name='{2}' and @Schema='{3}']","Parent.Parent.Parent.ConnectionContext.TrueName","Parent.Parent.Name","ValidationXmlSchemaCollection","ValidationXmlSchemaCollectionSchema")]
		[CLSCompliant(false)]
		public System.String ValidationXmlSchemaCollection
		{
			get
			{
				return (System.String)this.Properties.GetValueWithNullReplacement("ValidationXmlSchemaCollection");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("ValidationXmlSchemaCollection", value);
			}
		}
		[SfcProperty(SfcPropertyFlags.Standalone, "dbo")]
		public System.String ValidationXmlSchemaCollectionSchema
		{
			get
			{
				return (System.String)this.Properties.GetValueWithNullReplacement("ValidationXmlSchemaCollectionSchema");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("ValidationXmlSchemaCollectionSchema", value);
			}
		}
		internal override object GetPropertyDefaultValue(string propname)
		{
			switch (propname)
			{
				case "ValidationXmlSchemaCollectionSchema":
					return "dbo";
				default:
      ...
      public MessageTypeEvents Events
      {
          ...
          get
          {
              ...
              if (null == this.events)
              {
                  this.events = new MessageTypeEvents(this);
              }
              return this.events;
          }
      }
