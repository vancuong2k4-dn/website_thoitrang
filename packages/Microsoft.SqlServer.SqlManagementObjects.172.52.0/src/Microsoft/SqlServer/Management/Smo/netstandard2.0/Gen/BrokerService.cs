...
namespace Microsoft.SqlServer.Management.Smo.Broker
{
	...
	/// </summary>
	/// <inheritdoc/>
	public sealed partial class BrokerService  : IObjectPermission
	{
		public BrokerService() : base(){ }
		public BrokerService(ServiceBroker serviceBroker, string name) : base()
		{
			ValidateName(name);
		...
		internal class PropertyMetadataProvider : SqlPropertyMetadataProvider
		{
			...
			public override int PropertyNameToIDLookup(string propertyName)
			{
				...
				else
				{
					switch(propertyName)
					{
						...
						case "Owner": return 2;
						case "QueueName": return 3;
						case "QueueSchema": return 4;
			...
			internal static StaticMetadata [] staticMetadata = 
			{
				...
				new StaticMetadata("QueueName", false, false, typeof(System.String)),
				new StaticMetadata("QueueSchema", false, false, typeof(System.String)),
		...
		[SfcProperty(SfcPropertyFlags.Standalone)]
		[SfcReference(typeof(ServiceQueue),"Server[@Name = '{0}']/Database[@Name = '{1}']/ServiceBroker/ServiceQueue[@Name='{2}' and @Schema='{3}']","Parent.Parent.Parent.ConnectionContext.TrueName","Parent.Parent.Name","QueueName","QueueSchema")]
		[CLSCompliant(false)]
		public System.String QueueName
		{
			get
			{
				return (System.String)this.Properties.GetValueWithNullReplacement("QueueName");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("QueueName", value);
			}
		}
		[SfcProperty(SfcPropertyFlags.Standalone, "dbo")]
		public System.String QueueSchema
		{
			get
			{
				return (System.String)this.Properties.GetValueWithNullReplacement("QueueSchema");
			}
			set
			{
				Properties.SetValueWithConsistencyCheck("QueueSchema", value);
			}
		}
      ...
      public BrokerServiceEvents Events
      {
          ...
          get
          {
              ...
              if (null == this.events)
              {
                  this.events = new BrokerServiceEvents(this);
              }
              return this.events;
          }
      }
