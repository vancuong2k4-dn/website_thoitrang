...
namespace LTW.Areas.Admin.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        private List<NCC> SearchByName(string searchString)
        {
            var result = from ncc in data.NCCs
                         where ncc.TenNCC.Contains(searchString) ||
                               ncc.SDT.Contains(searchString) ||
                               ncc.Email.Contains(searchString)
        ...
        public ActionResult ListNhaCungCap(string searchString)
        {
            ...
            var all_ncc = from ncc in data.NCCs
                          orderby ncc.MaNCC descending
                          select ncc;
